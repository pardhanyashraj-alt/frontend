...
// Reusable Student Sidebar Component (inline for simplicity)
function StudentSidebar({ activePage }: { activePage: string }) {
    ...
    <>
      ...
      <nav className={`sidebar${collapsed ? " collapsed" : ""}${isMobile && !collapsed ? " mobile-open" : ""}`}>
        ...
        <div className="nav-group">
          ...
          <Link href="#" className="nav-item" onClick={closeMobileSidebar}>
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/></svg>
            My Classes
          </Link>
          <Link href="#" className="nav-item" onClick={closeMobileSidebar}>
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            Assignments
        ...
        <div className="sidebar-user">
          <div className="avatar mr" style={{ background: '#059669' }}>AK</div>
          <div>
      ...
      <button className={`sidebar-toggle${collapsed ? " collapsed-state" : ""}${isMobile && !collapsed ? " mobile-toggle-open" : ""}`} onClick={toggleSidebar}>
